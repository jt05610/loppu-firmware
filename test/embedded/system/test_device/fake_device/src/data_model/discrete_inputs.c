...
static inline void read_on_button(sized_array_t * dest);
...
/**
 * @brief reads on_button
 * @param dest Array to store results into.
 **/
static inline void
read_on_button(sized_array_t * dest)
{
    /* start read_on_button code */
    
    /* end read_on_button code */
}
