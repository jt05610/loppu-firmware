...
/* Private defines -----------------------------------------------------------*/
#define FORWARD_BUTTON_Pin GPIO_PIN_0
#define FORWARD_BUTTON_GPIO_Port GPIOA
#define FORWARD_BUTTON_EXTI_IRQn EXTI0_1_IRQn
#define BACK_BUTTON_Pin GPIO_PIN_1
#define BACK_BUTTON_GPIO_Port GPIOA
#define BACK_BUTTON_EXTI_IRQn EXTI0_1_IRQn
