...
/** @defgroup TIM_LL_Private_Functions TIM Private Functions
  ...
  */
static ErrorStatus
OC1Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct);

static ErrorStatus
OC2Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct);

static ErrorStatus
OC3Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct);

static ErrorStatus
OC4Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct);

static ErrorStatus
OC5Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct);

static ErrorStatus
OC6Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct);

static ErrorStatus
IC1Config(TIM_TypeDef * TIMx, const LL_TIM_IC_InitTypeDef * TIM_ICInitStruct);

static ErrorStatus
IC2Config(TIM_TypeDef * TIMx, const LL_TIM_IC_InitTypeDef * TIM_ICInitStruct);

static ErrorStatus
IC3Config(TIM_TypeDef * TIMx, const LL_TIM_IC_InitTypeDef * TIM_ICInitStruct);

static ErrorStatus
IC4Config(TIM_TypeDef * TIMx, const LL_TIM_IC_InitTypeDef * TIM_ICInitStruct);
/**
  * @}
  */
...
/**
  ...
  */
ErrorStatus
LL_TIM_Init(TIM_TypeDef * TIMx, const LL_TIM_InitTypeDef * TIM_InitStruct)
{
    uint32_t tmpcr1;
...
/**
  ...
  */
void
LL_TIM_ENCODER_StructInit(LL_TIM_ENCODER_InitTypeDef * TIM_EncoderInitStruct)
{
    /* Set the default configuration */
...
)
{
    ...
    /* Configure TI1 */
    tmpccmr1 &= (uint32_t) ~(TIM_CCMR1_CC1S | TIM_CCMR1_IC1F
                             | TIM_CCMR1_IC1PSC);
    ...
    /* Configure TI2 */
    tmpccmr1 &= (uint32_t) ~(TIM_CCMR1_CC2S | TIM_CCMR1_IC2F
                             | TIM_CCMR1_IC2PSC);
...
/**
  ...
  */
void
LL_TIM_HALLSENSOR_StructInit(LL_TIM_HALLSENSOR_InitTypeDef * TIM_HallSensorInitStruct)
{
    /* Set the default configuration */
...
)
{
    ...
    assert_param(IS_LL_TIM_IC_POLARITY_ENCODER(
            TIM_HallSensorInitStruct->IC1Polarity
    ));
...
)
{
    ...
    assert_param(IS_LL_TIM_AUTOMATIC_OUTPUT_STATE(
    ...
    if (IS_TIM_BKIN2_INSTANCE(TIMx))
    {
        ...
        assert_param(
                IS_LL_TIM_BREAK2_POLARITY(TIM_BDTRInitStruct->Break2Polarity));
...
OC1Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct)
{
    ...
    if (IS_TIM_BREAK_INSTANCE(TIMx))
    {
        ...
        MODIFY_REG(tmpccer, TIM_CCER_CC1NP,
                   TIM_OCInitStruct->OCNPolarity << 2U);
...
OC2Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct)
{
    ...
    if (IS_TIM_BREAK_INSTANCE(TIMx))
    {
        ...
        /* Set the complementary output Polarity */
        MODIFY_REG(tmpccer, TIM_CCER_CC2NP,
                   TIM_OCInitStruct->OCNPolarity << 6U);
...
OC3Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct)
{
    ...
    if (IS_TIM_BREAK_INSTANCE(TIMx))
    {
        ...
        /* Set the complementary output Polarity */
        MODIFY_REG(tmpccer, TIM_CCER_CC3NP,
                   TIM_OCInitStruct->OCNPolarity << 10U);
...
OC5Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct)
{
    ...
    if (IS_TIM_BREAK_INSTANCE(TIMx))
    {
        ...
        /* Set the Output Idle state */
        MODIFY_REG(TIMx->CR2, TIM_CR2_OIS5,
                   TIM_OCInitStruct->OCIdleState << 8U);
...
OC6Config(TIM_TypeDef * TIMx, const LL_TIM_OC_InitTypeDef * TIM_OCInitStruct)
{
    ...
    if (IS_TIM_BREAK_INSTANCE(TIMx))
    {
        ...
        /* Set the Output Idle state */
        MODIFY_REG(TIMx->CR2, TIM_CR2_OIS6,
                   TIM_OCInitStruct->OCIdleState << 10U);
    }
...
IC1Config(TIM_TypeDef * TIMx, const LL_TIM_IC_InitTypeDef * TIM_ICInitStruct)
{
    ...
    MODIFY_REG(TIMx->CCMR1,
               ...
               (TIM_ICInitStruct->ICActiveInput | TIM_ICInitStruct->ICFilter
                | TIM_ICInitStruct->ICPrescaler) >> 16U);
...
IC2Config(TIM_TypeDef * TIMx, const LL_TIM_IC_InitTypeDef * TIM_ICInitStruct)
{
    ...
    MODIFY_REG(TIMx->CCMR1,
               ...
               (TIM_ICInitStruct->ICActiveInput | TIM_ICInitStruct->ICFilter
                | TIM_ICInitStruct->ICPrescaler) >> 8U);
