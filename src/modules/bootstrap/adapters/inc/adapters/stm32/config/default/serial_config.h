...
#define STM32_USART2_RX_BUFFER_SIZE     256
...
#define STM32_USART2_TX_DMA             0

/** @brief Enable STM32 RTO interrupt */
#define STM32_USART2_RTO_ENABLE         1
