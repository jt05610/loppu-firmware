...
#ifndef INJECTOR_ADC_ADV_CONFIG_H
#define INJECTOR_ADC_ADV_CONFIG_H
...
/**
 * @defgroup STM32G0xx_ADCAdvConfig ADC advanced config
...
#endif //INJECTOR_ADC_ADV_CONFIG_H
